module "wrapper" {
  ...
  attach_aws_global_accelerator_controller_policy          = try(each.value.attach_aws_global_accelerator_controller_policy, var.defaults.attach_aws_global_accelerator_controller_policy, false)
  ...
  attach_pganalyze_policy                                  = try(each.value.attach_pganalyze_policy, var.defaults.attach_pganalyze_policy, false)
  ...
  aws_global_accelerator_controller_policy_name            = try(each.value.aws_global_accelerator_controller_policy_name, var.defaults.aws_global_accelerator_controller_policy_name, null)
  ...
  pganalyze_policy_name                                    = try(each.value.pganalyze_policy_name, var.defaults.pganalyze_policy_name, null)
